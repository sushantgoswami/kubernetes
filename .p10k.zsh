# Generated by Powerlevel10k configuration wizard on 2022-04-16 at 19:18 IST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 51782.
# Wizard options: compatible, lean_8colors, unicode, 2 lines, dotted, left frame,
# green-ornaments, compact, concise, transient_prompt, instant_prompt=auto-off.
